...
const DashboardLayout = ({ children }: DashboardLayoutProps) => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background dark:bg-gray-900">
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : "text-sidebar-foreground hover:bg-sidebar-accent/50 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white"
                  )}
                >
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          <div className="flex items-center">
            <Avatar>
              ...
              <AvatarFallback className="bg-primary dark:bg-gray-700">
                {user?.name ? getInitials(user.name) : "U"}
              </AvatarFallback>
            </Avatar>
            <div className="ml-3">
              <p className="text-sm font-medium text-sidebar-foreground dark:text-gray-200 truncate">
                {user?.name}
              </p>
              <p className="text-xs text-sidebar-foreground/70 dark:text-gray-400 capitalize">
                {user?.role}
              </p>
              <p className="text-xs text-sidebar-foreground/70 dark:text-gray-400">
                ID: {user?.id}
              </p>
            </div>
          </div>
          <Button 
            ...
            variant="ghost" 
            className="w-full mt-2 text-sidebar-foreground dark:text-gray-300 hover:bg-sidebar-accent/50 dark:hover:bg-gray-800"
          >
      ...
      <div
        className={cn(
          "fixed inset-0 z-40 lg:hidden bg-black/50 dark:bg-black/70 transition-opacity",
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-72 bg-sidebar dark:bg-gray-900 transform transition-transform lg:hidden",
      ...
      >
        <div className="flex items-center justify-between h-16 border-b border-gray-200 dark:border-gray-700 px-6">
          ...
          <Button 
            ...
            size="icon" 
            onClick={() => setSidebarOpen(false)}
            className="text-sidebar-foreground dark:text-gray-300 hover:bg-sidebar-accent/50 dark:hover:bg-gray-800"
          >
            <X className="h-5 w-5" />
          </Button>
        </div>
